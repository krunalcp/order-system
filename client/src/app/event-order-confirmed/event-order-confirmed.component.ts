...
@Component({
  ...
  templateUrl: './event-order-confirmed.component.html',
  styleUrls: ['./event-order-confirmed.component.css']
})
export class EventOrderConfirmedComponent implements OnInit {
